		...
		>
			...
			<Box sx={{ my: 4 }}>
				...
				<Typography variant="h6" component="h2" gutterBottom>
					I&apos;m a user interface engineer with a passion for building modern
			...
			>
				<Typography variant="body1" component="h4" gutterBottom>
					...
					technology, I strive to create applications that provide real value to
					users and deliver results for businesses. Take a look around to see
					some of my latest projects and learn more about my skills and
					experience.
				</Typography>
			</Box>
